...
* Deploy AKS cluster
*/
module aksClusterDeployment './modules/_azure-resoruces/_aks.bicep' = if (createAKSCluster) {
...
output keyCloakUrl string = vzDeployment.outputs.keyCloakUrl
output kialiUrl string = vzDeployment.outputs.kialiUrl
output openSearchDashboardsUrl string = vzDeployment.outputs.openSearchDashboardsUrl
output openSearchUrl string = vzDeployment.outputs.openSearchUrl
output prometheusUrl string = vzDeployment.outputs.prometheusUrl
output rancherUrl string = vzDeployment.outputs.rancherUrl